...
export default function AvitionItem() {
    return (
        <div className="flex flex-row py-16 justify-center">
            ...
            <Image src="/aviation 1.png" width="300" height="300" />
        </div>
    );
};